...
class UserManager(models.Manager):
    def basic_validations(self, postData):
        ...
        if len(postData['name']) == 0:
            ...
            errors['name'] = "This field must be longer than 2 characters"
        elif len(postData['name']) > 30:
            errors['name'] = "This field cannot be longer than 30 characters"

        # validations for alias
        if len(postData['alias']) == 0:
            errors['alias'] = "This field cannot be blank"
        elif len(postData['alias']) < 3:
            errors['alias'] = "This field must be longer than 2 characters"
        elif len(postData['alias']) > 30:
            errors['alias'] = "This field cannot be longer than 30 characters"
